...
<div>
    <div class="flex flex-col gap-6 max-w-4xl">
        ...
        <div>
            ...
            <p class="text-sm text-slate-500 mt-1">Isi formulir berikut untuk menambahkan kendaraan baru ke daftar rental.</p>
        </div>
            ...
            <div class="p-6 sm:p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="merk" wire:model.live="merk" placeholder="Contoh: Honda, Toyota, Yamaha"
                    ...
                    <div>
                        ...
                        <input type="text" id="nama" wire:model.live="nama" placeholder="Contoh: Brio Satya, NMAX 155"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" id="tahun" wire:model.live="tahun" placeholder="{{ date('Y') }}" min="2000" max="{{ date('Y') + 1 }}"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="harga_sewa" wire:model.live="harga_sewa" placeholder="150000" min="10000" step="1000"
                ...
                <div>
                    ...
                    <textarea id="deskripsi" wire:model.live="deskripsi" rows="4" placeholder="Deskripsi singkat tentang kendaraan (opsional)..."
