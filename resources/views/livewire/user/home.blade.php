...
<div>
    ...
    <section class="relative w-full min-h-[calc(100vh-5rem)] flex items-center bg-slate-900 overflow-hidden">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-12 pb-24">
            <div class="max-w-3xl">
                <span class="inline-flex items-center px-4 py-1.5 rounded-full text-xs font-bold tracking-widest uppercase bg-indigo-500/10 text-indigo-300 border border-indigo-500/20 backdrop-blur-sm mb-6 shadow-[0_0_15px_rgba(99,102,241,0.2)]">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-tight mb-6">
                    ...
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-violet-400">Petualangan Barumu</span>
                </h1>
                <p class="text-lg text-slate-300 mb-10 max-w-2xl leading-relaxed">
                    Platform penyewaan kendaraan terpercaya. Rencanakan perjalanan Anda tanpa ribet dengan pilihan motor dan mobil terbaik di seluruh Indonesia.
                </p>
            </div>

            {{-- ─── Search Box (Glassmorphism) ─── --}}
            <div class="w-full max-w-5xl rounded-2xl border border-white/15 bg-white/5 p-6 md:p-8 backdrop-blur-md shadow-2xl">
                <div class="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div class="inline-flex items-center gap-2 rounded-2xl border border-emerald-500/20 bg-emerald-500/10 px-4 py-2.5 backdrop-blur-sm">
                        <span class="relative flex h-3 w-3">
                            <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                            <span class="relative inline-flex rounded-full h-3 w-3 bg-emerald-500"></span>
                        </span>
                        <div class="flex flex-col">
                            <span class="text-[10px] uppercase tracking-widest text-emerald-300 font-semibold leading-none">Tersedia</span>
                ...
                <form action="{{ route('user.pencarian') }}" method="GET">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 md:items-end">
                        ...
                        <div class="flex flex-col gap-2">
                            <label for="jenis_kendaraan" class="text-sm font-semibold text-slate-300">Jenis Kendaraan</label>
                            <div class="relative">
