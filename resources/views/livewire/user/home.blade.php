        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-12 pb-24">
            <div class="max-w-3xl">
                ...
                <p class="text-lg text-slate-300 mb-10 max-w-2xl leading-relaxed">
                    ...
                    dan
                    mobil terbaik di seluruh Indonesia.
                </p>
            </div>

            <!-- Search Box (Glassmorphism) -->
            <div
                class="w-full max-w-5xl rounded-2xl border border-white/15 bg-white/2 p-6 md:p-8 backdrop-blur-md shadow-2xl">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <div class="relative">
                                <select id="brand" name="brand"
                                    ...
                                    <!-- Opsi dinamis bisa ditambahkan dari Controller -->
                                </select>
                                <div
