        ...
        <nav
                ...
                <div class="flex justify-between items-center h-20">
                    ...
                    <div class="hidden md:flex items-center gap-8">
                        <a wire:navigate href="{{ route('home') }}"
                            class="text-sm font-semibold transition-all duration-200 {{ request()->routeIs('home') ? 'text-indigo-600' : 'text-slate-600 hover:text-indigo-600' }}">
                            Beranda
                        </a>
                        <a wire:navigate href="{{ route('user.daftar') }}"
                            class="text-sm font-semibold transition-all duration-200 {{ request()->routeIs('user.daftar') ? 'text-indigo-600' : 'text-slate-600 hover:text-indigo-600' }}">
                            Katalog
                        </a>
                        <a wire:navigate href="{{ route('user.pencarian') }}"
                            class="text-sm font-semibold transition-all duration-200 {{ request()->routeIs('user.pencarian') ? 'text-indigo-600' : 'text-slate-600 hover:text-indigo-600' }}">
                            Cari
                        </a>
                        <a wire:navigate href="{{ route('user.history') }}"
                            class="text-sm font-semibold transition-all duration-200 {{ request()->routeIs('user.history') ? 'text-indigo-600' : 'text-slate-600 hover:text-indigo-600' }}">
                            Riwayat
                        </a>
                    </div>
            ...
            <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-200"
                ...
                <div class="px-4 pt-2 pb-6 space-y-1 flex flex-col">
                    <a wire:navigate href="{{ route('home') }}"
                        class="block px-4 py-3 rounded-xl text-base font-medium {{ request()->routeIs('home') ? 'bg-indigo-50 text-indigo-700' : 'text-slate-700 hover:bg-slate-50' }}">Beranda</a>
                    <a wire:navigate href="{{ route('user.daftar') }}"
                        class="block px-4 py-3 rounded-xl text-base font-medium {{ request()->routeIs('user.daftar') ? 'bg-indigo-50 text-indigo-700' : 'text-slate-700 hover:bg-slate-50' }}">Katalog
                        Kendaraan</a>
                    <a wire:navigate href="{{ route('user.pencarian') }}"
                        class="block px-4 py-3 rounded-xl text-base font-medium {{ request()->routeIs('user.pencarian') ? 'bg-indigo-50 text-indigo-700' : 'text-slate-700 hover:bg-slate-50' }}">Pencarian</a>
                    <a wire:navigate href="{{ route('user.history') }}"
                        class="block px-4 py-3 rounded-xl text-base font-medium {{ request()->routeIs('user.history') ? 'bg-indigo-50 text-indigo-700' : 'text-slate-700 hover:bg-slate-50' }}">Riwayat</a>
                </div>
            </div>
        </nav>
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="flex items-center gap-4">
                            <a href="https://wa.me/6281234567890" target="_blank"
                                class="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-500 hover:bg-green-50 hover:text-green-600 transition-colors">
                            ...
                            <a href="https://www.instagram.com/melakuy/"
                                class="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-500 hover:bg-indigo-50 hover:text-indigo-600 transition-colors">
