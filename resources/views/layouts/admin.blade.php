        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="flex-1 overflow-y-auto px-4 py-6 space-y-1 custom-scrollbar">
                ...
                <a href="{{ route('admin.dashboard') }}"
                    class="flex items-center gap-3 rounded-xl bg-indigo-500/10 px-4 py-3 text-sm font-semibold text-indigo-400 transition-colors">
                ...
                <a href="{{ route('admin.pemesanan') }}"
                    ...
                    Pemesanan
                    {{-- kalau ada pesanan baru sesuai db, tambahkan badge notifikasi di sini --}}
                    {{-- <span class="ml-auto bg-rose-500 text-white text-xs font-bold px-2 py-0.5 rounded-full">3</span> --}}
                </a>
