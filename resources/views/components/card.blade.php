...
<a href="{{ $link }}" class="group relative flex flex-col h-full bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:border-indigo-100 transition-all duration-300 overflow-hidden transform hover:-translate-y-1">
    ...
    <div class="flex flex-col flex-grow p-5">
        ...
        <div class="mt-auto pt-4 border-t border-slate-100 flex items-center justify-between">
            ...
            <div class="w-8 h-8 rounded-full bg-indigo-50 flex items-center justify-center text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white transition-colors">
